    ...
    return(
        <div className="WelcomePanel panel">
            ...
            <h1>Hello, my name is Soren</h1>
                ...
                <p>My programming journey started around 6 years ago, when I got introduced to C# in a class I was taking. I was hooked from the start, and have been ever since! I quickly changed from C# to HTML, CSS and Javascript, as well as PHP and SQL. My current focus is mastering ReactJS and Sass/Scss!</p>
            </div>
        </div>
    );
}
